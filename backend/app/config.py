...
# Underlying Postgres object name for the published online table. Set once the setup job has
# published the table and we've inspected the resulting Postgres schema.
